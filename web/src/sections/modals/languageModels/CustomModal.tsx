        ...
        <Section gap={0.75}>
          <Content
            ...
            description={markdown(
              "Add extra properties as needed by the model provider. These are passed to LiteLLM's `completion()` call as [environment variables](https://docs.litellm.ai/docs/set_keys#environment-variables). See [documentation](/) for more instructions."
            )}
            width="full"
            variant="section"
