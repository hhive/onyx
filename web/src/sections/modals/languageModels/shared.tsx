...
/**
 * Sentence appended to an API Base URL `subDescription` when 小逆talk is detected
 * to be running inside a container — explains why the default uses
 * `host.docker.internal`.
 */
export const CONTAINERIZED_HOST_NOTE =
  "With 小逆talk running in a container, `host.docker.internal` acts like `localhost` inside the container.";
