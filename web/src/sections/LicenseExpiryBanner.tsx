...
function buildCopy(
  ...
  if (stage === "t_30d") {
    return {
      title: `Your 小逆talk license expires on ${expiresDisplay}.`,
      description:
        "Renewal is due in approximately 30 days. Contact your 小逆talk representative to renew.",
      variant: "warning",
    };
  }
  if (stage === "t_14d") {
  ...
  if (stage === "t_1d") {
    return {
      title: `Your 小逆talk license expires tomorrow (${expiresDisplay}).`,
      description:
  ...
  if (stage === "grace") {
    return {
      title: `Your 小逆talk license expired on ${expiresDisplay}.`,
