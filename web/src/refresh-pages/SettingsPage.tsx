    ...
    <Section gap={2}>
      <Section gap={0.75}>
        ...
        <Card>
          <InputHorizontal
            title="Default Model"
            description="This model will be used by 小逆talk by default in your chats."
            withLabel
          >
            <LLMPopover
      ...
      <Section gap={0.75}>
        ...
        <Card>
          <InputHorizontal
            ...
            description="Let 小逆talk reference stored memories in chats."
            withLabel
          >
            <Switch
          ...
          <InputHorizontal
            ...
            description="Let 小逆talk generate and update stored memories."
            withLabel
          >
            <Switch
        ...
        >
          <Section gap={0.5} alignItems="start">
            <Text>
              ...
              lose access to 小逆talk. This action cannot be undone.
            </Text>
    ...
    <>
      {showDisconnectConfirmation && (
        ...
        >
          <Section gap={0.5} alignItems="start">
            <Text>
              小逆talk will no longer be able to access or search content from your{" "}
