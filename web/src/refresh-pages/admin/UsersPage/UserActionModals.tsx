  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will no longer be able to join 小逆talk with this invite.
      </Text>
    </ConfirmationModalLayout>
  );
}
  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will immediately lose access to 小逆talk. Their sessions and agents will be
  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will be permanently removed from 小逆talk. All of their session history will
