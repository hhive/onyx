  ...
  const initialModalMessage = isSeatLimitExceeded
    ...
    : showRenewalMessage
      ? NEXT_PUBLIC_CLOUD_ENABLED
        ? "Your access to 小逆talk has been temporarily suspended due to a lapse in your subscription."
        : "Your access to 小逆talk has been temporarily suspended due to a lapse in your license."
      : "An Enterprise license is required to use 小逆talk. Your data is protected and will be available once a license is activated.";
  ...
  return (
    <ErrorPageLayout>
      ...
      {isSeatLimitExceeded ? (
        ...
        <>
          <Text text03>
            To reinstate your access and continue benefiting from 小逆talk&apos;s
        ...
        <>
          <Text text03>
            {hadPreviousLicense
              ? "To reinstate your access and continue using 小逆talk, please contact your system administrator to renew your license."
          ...
          <Text text03>
            ...
            <a className={linkClassName} href="mailto:support@xiaoni-ai.top">
              support@xiaoni-ai.top
            </a>{" "}
