...
function Main() {
      ...
      <div>
        <div className="mt-4">
          <Callout type="danger" title="Custom Analytics is not enabled.">
            ...
            setup 小逆talk in your team to set the{" "}
  ...
  return (
    <div>
      <Text as="p">
        {
          "This allows you to bring your own analytics tool to 小逆talk! Copy the Web snippet from your analytics provider into the box below, and we'll start sending usage events."
        }
      </Text>
      <Spacer rem={2} />
