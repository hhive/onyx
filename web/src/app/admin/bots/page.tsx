  ...
  return (
    <div className="mb-8">
      <p className="mb-2 text-sm text-muted-foreground">
        Setup Slack bots that connect to 小逆talk. Once setup, you will be able to
        ask questions to 小逆talk directly from Slack. Additionally, you can:
      </p>
      ...
      <p className="mb-6 text-sm text-muted-foreground">
        ...
        found in the 小逆talk documentation to get started!
      </p>
