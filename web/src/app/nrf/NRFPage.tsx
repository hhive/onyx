...
export default function NRFPage({ isSidePanel = false }: NRFPageProps) {
  ...
  // If user toggles the "Use 小逆talk" switch to off, prompt a modal
          ...
          <Modal open={showTurnOffModal} onOpenChange={setShowTurnOffModal}>
            <Modal.Content width="sm">
              <Modal.Header
                ...
                title="Turn off 小逆talk new tab page?"
                description="You'll see your browser's default new tab page instead. You can turn it back on anytime in your 小逆talk settings."
      ...
      {!user && (
        <Modal open onOpenChange={() => {}}>
          <Modal.Content width="sm" height="sm">
            <Modal.Header icon={SvgUser} title="Welcome to 小逆talk" />
            <Modal.Body>
